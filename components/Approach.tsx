  ...
  return (
    <section className="w-full py-20">
      <h1 className="heading text-3xl md:text-6xl sm:text-6xl text-wrap text-white font-bold gap-x-2">
        How I <span className="text-purple-300">approach</span> towards my projects
      </h1>
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4 text-white">
        ...
        <Card
          ...
          des="I will collaborate with my team to map out our application goals, target audience, 
