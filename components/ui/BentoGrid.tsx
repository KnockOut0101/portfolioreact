  ...
  return (
    ...
    >
        <div className={`${id==6} && 'flex justify-center h-full'`}>
            ...
            {/* {id == 2 && <GlobeDemo/> TO BE WORKED UPON
            } */}

            { id == 3 && (
                <div className = "flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
                    <div className = "flex flex-col gap-3 lg:gap-6 pt-11">
                    ...
                    <div className = "flex flex-col gap-3 lg:gap-8">
                        ...
                        ((item) => (
                            <span key={item} className='py-1 lg:py-4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-md text-center bg-[#10132E]'>
                                {item}
                            </span>
                        ))}
                    </div>
