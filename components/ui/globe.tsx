...
// import { Color, Vector3, Scene, Fog, PerspectiveCamera } from "three";
// import { useThree, Canvas, extend } from "@react-three/fiber";
// import { OrbitControls } from "@react-three/drei";
// import ThreeGlobe from "three-globe";
// import countries from "@/data/globe.json"; // Ensure globe.json is correct
...
// // Define WorldProps to include globeConfig and data
// interface Position {
//   order: number;
//   startLat: number;
//   startLng: number;
...
//       // Check if rgb is not null before using it
//       if (rgb) {
//         points.push({
...
//         });
//       } else {
//         // Handle the case where hex color is invalid (rgb is null)
//         console.warn(`Invalid hex color: ${arc.color}`);
//       }
//     }
...
//   return (
//     <>{globeRef.current && <primitive object={globeRef.current} />}</> // Render globe
//   );
// }
